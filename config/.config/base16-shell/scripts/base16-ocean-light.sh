...
# Ocean Light scheme by Ryan Wilson-Perkin
...
color08="65/73/7e" # Bright Black
color09="d0/87/70" # Bright Red
color10="34/3d/46" # Bright Green
color11="4f/5b/66" # Bright Yellow
color12="a7/ad/ba" # Bright Blue
color13="df/e1/e8" # Bright Magenta
color14="ab/79/67" # Bright Cyan
color15="ef/f1/f5" # Bright White
...
color_foreground=$color11 # Bright Yellow
color_background=$color15 # Bright White
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 4f5b66 # foreground
  put_template_custom Ph eff1f5 # background
  put_template_custom Pi 4f5b66 # bold color
  put_template_custom Pj c0c5ce # selection color
  put_template_custom Pk 4f5b66 # selected text color
  put_template_custom Pl 4f5b66 # cursor
